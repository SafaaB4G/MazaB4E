...
class GolfController: UIViewController{
    ...
    override func viewDidLoad() {
        ...
        descriptionGray = String (describing:grayMenu["description"])
        descriptionAcademic = String (describing:academicMenu["description"])
        descriptionProshop = String (describing:proshopMenu["description"])
