...
class RestaurationView: UIViewController ,ITRFlipperDataSource{
    ...
    override func viewDidLoad() {
        ...
        descriptionOne = String (describing:one["description"])
        descriptionTwo = String (describing:two["description"])
        descriptionTree = String (describing:three["description"])
        descriptionFor = String (describing:four["description"])
        descriptionFive = String (describing:five["description"])
        descriptionSex = String (describing:sex["description"])
        descriptionSeven = String (describing:seven["description"])
        descriptionEight = String (describing:eight["description"])
        descriptionNine = String (describing:nine["description"])
        descriptionTen = String (describing:ten["description"])
        descriptionEleven = String (describing:eleven["description"])
        descriptionTwelve = String (describing:twelve["description"])
        descriptionThirteen = String (describing:thirteen["description"])
        descriptionForteen = String (describing:forteen["description"])
        descriptionFifteen = String (describing:fifteen["description"])
        descriptionSexteen = String (describing:sexteen["description"])
...
//                case coverHorizontalFromLef
    ...
    func getDescription() -> String {
        ...
        let descriptionResaturation : String = String (describing:restaurationMenu["description"])
